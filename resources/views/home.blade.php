...
<link rel="stylesheet" type="text/css" href="{{asset('public/frontend/plugins/OwlCarousel2-2.2.1/owl.theme.default.cs')}}s">
            ...
            <div class="container">
                <div class="row">
                    <div class="col d-flex flex-row">
                        <div class="top_bar_contact_item"><div class="top_bar_icon"><img src="images/phone.png" alt=""></div>+84 03456789</div>
                        <div class="top_bar_contact_item"><div class="top_bar_icon"><img src="images/mail.png" alt=""></div><a href="mailto:fastsales@gmail.com">support@ibuy.com</a></div>
                            ...
                            <div class="header_search_content">
                                <div class="header_search_form_container">
                                    <form action="#" class="header_search_form clearfix">
                                        <input type="search" required="required" class="header_search_input" placeholder="Nhập sản phẩm bạn muốn tìm">
                                        <div class="custom_dropdown">
                                            <div class="custom_dropdown_list">
                                                <span class="custom_dropdown_placeholder clc"><!-- Danh mục sản phẩm --></span>
                                                <i class="fas fa-chevron"></i>
                                                <ul class="custom_list clc">
                                                    <li><a class="clc" href="#"><!-- Danh Mục --></a></li>
                                                    <li><a class="clc" href="#"><!-- Máy tính --></a></li>
                                                    <li><a class="clc" href="#"><!-- sdsấ --></a></li>
                                                    <li><a class="clc" href="#"><!-- ádsad --></a></li>
                                                    <li><a class="clc" href="#"><!-- Hardádsaware --></a></li>
                                                    <li><a class="clc" href="#"><!-- Smartphonsadsadases --></a></li>
                                                </ul>
                                            </div>
                                        </div>
                            ...
                            <div class="cart">
                                <div class="cart_container d-flex flex-row align-items-center justify-content-end">
                                    ...
                                    <div class="cart_content">
                                        <div class="cart_text"><a href="#"><i class="fas fa-cart-plus"></i> Giỏ hàng</a></div>
    ...
    <div class="characteristics">
        ...
        <div class="banner">
            ...
            <div class="container fill_height">
                <div class="row fill_height">
                    <div class="banner_product_image" style="top: -69px;"><img src="https://o.remove.bg/downloads/7a5771ed-77b8-4efe-b385-ff3cfdc47fe8/Untitled-1-removebg-preview.png" alt=""></div>
        ...
        <div class="row">
            <div class="col-md-8" style="padding: 0;padding-top: 20px;">
                <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel" style="width: 95%;  margin-left: 15px;">
          <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="https://cdn.tgdd.vn/2020/10/banner/800-170-800x170-45.png" class="" alt="...">
            </div>
            <div class="carousel-item">
              <img src="https://cdn.tgdd.vn/2020/10/banner/iphone-12-800-170-800x170-3.png" class="" alt="...">
            </div>
            <div class="carousel-item">
              <img src="https://cdn.tgdd.vn/2020/10/banner/a51-71-800-170-800x170.png" class="" alt="...">
            </div>
          </div>
        </div>
            </div> <!-- col -->
            <div class="col-md-4" style="padding: 0;padding-top: 20px;">
                <div class="quangcao"> 
                    <div class="anh1">
                        <img src="https://cdn.tgdd.vn/2020/09/banner/A31-11-390-80-390x80-4.png" alt="" style="padding-bottom: 10px;">
                    </div>
                    <div class="anh2">
                        <img src="https://cdn.tgdd.vn/2020/09/banner/sticky-oppo-a523-390-80-390x80.png" alt="">
                    </div>
                        ...
                        <div class="deals_slider_container">
                            ...
                            <div class="owl-carousel owl-theme deals_slider">
                                ...
                                <div class="owl-item deals_item">
                                    <div class="deals_image"><img src="https://cdn.tgdd.vn/Products/Images/42/228744/iphone-12-pro-max-512gb-191020-021035-400x400.jpg" alt=""></div>
                            ...
                            <div class="row fill_height">
                                <div class="col-lg-4 col-md-6 fill_height">
                                    <div class="banner_2_content">
                                        ...
                                        <div class="banner_2_text">iPhone 12 Pro sẽ nói không với tai thỏ, thiết kế mạnh mẽ hơn</div>
                                ...
                                <div class="col-lg-8 col-md-6 fill_height">
                                    <div class="banner_2_image_container">
                                        <div class="banner_2_image"><img src="https://o.remove.bg/downloads/b7fb18f4-df38-4ac6-ad65-be927808077d/12pro-removebg-preview.png" alt=""></div>
                                    </div>
                                </div>
                            </div>
                        </div>          
                            ...
                            <div class="row fill_height">
                                <div class="col-lg-4 col-md-6 fill_height">
                                    <div class="banner_2_content">
                                        ...
                                        <div class="banner_2_text">Công nghệ hiển thị: Màn hình cảm ứng điện dung Liquid Retina IPS LCD, 16 triệu màuĐộ phân giải: 828 x 1792 pixels Màn hình rộng: 6.1 inches IPS LCD Mặt kính cảm ứng: Kính chống trầy xước, lớp phủ oleophobic</div>
                                        <div class="rating_r rating_r_4 banner_2_rating"><i></i><i></i><i></i><i></i><i></i></div>
                                        <div class="button banner_2_button"><a href="#">Xem thêm</a></div>
                                    </div>
                                ...
                                <div class="col-lg-8 col-md-6 fill_height">
                                    <div class="banner_2_image_container">
                                        <div class="banner_2_image"><img src="https://lh3.googleusercontent.com/proxy/IyY3bwyxVzei5Ov3Ua0IzpjldF9GI21vRLXxXOlKVAsp_9PyO_n1HiXstjG7LT1dA2Y2YbpumDHoMJwnzEpifR5pQXxwuZm-NOqyqH05zT55x3KUDCOsaG3IyBBG33xDl9f9WLI5MqO_" alt=""></div>
                                    </div>
                                </div>
                            </div>
                        </div>          
                            ...
                            <div class="row fill_height">
                                <div class="col-lg-4 col-md-6 fill_height">
                                    <div class="banner_2_content">
                                        ...
                                        <div class="banner_2_text">iPhone 11 được trang bị hệ thống camera kép đột phá với camera ống kính siêu rộng Ultra Wide và camera ống kính rộng Wide mang lại những video và bức ảnh tuyệt vời. </div>
                                        <div class="rating_r rating_r_4 banner_2_rating"><i></i><i></i><i></i><i></i><i></i></div>
                                        <div class="button banner_2_button"><a href="#">Xem thêm</a></div>
                                    </div>
                                ...
                                <div class="col-lg-8 col-md-6 fill_height">
                                    <div class="banner_2_image_container">
                                        <div class="banner_2_image"><img src="https://o.remove.bg/downloads/0a814641-e70a-4f95-8ce0-b772f3b54d08/pngtree-iphone-11-png-png-image_1730413-removebg-preview.png" alt=""></div>
                                    </div>
                                </div>
                            </div>
                        </div>          
                            ...
                            <div class="bestsellers_slider slider">
                                ...
                                <div class="bestsellers_item discount">
                                    <div class="bestsellers_item_container d-flex flex-row align-items-center justify-content-start">
                                        <div class="bestsellers_image"><img src="https://cdn.tgdd.vn/Products/Images/42/228744/iphone-12-pro-max-512gb-191020-021035-600x600.jpg" alt=""></div>
                                        <div class="bestsellers_content">
                                            <div class="bestsellers_category"><a href="#">Iphone</a></div>
                                            <div class="bestsellers_name"><a href="product.html">iPhone 12 Pro Max</a></div>
                                ...
                                <div class="bestsellers_item discount">
                                    <div class="bestsellers_item_container d-flex flex-row align-items-center justify-content-start">
                                        <div class="bestsellers_image"><img src="https://cdn.tgdd.vn/Products/Images/42/224859/samsung-galaxy-s20-fan-edition-242020-012039-600x600.jpg" alt=""></div>
                                        <div class="bestsellers_content">
                                            <div class="bestsellers_category"><a href="#">Samsung</a></div>
                                            <div class="bestsellers_name"><a href="product.html">Samsung Galaxy S20</a></div>
                                            <div class="rating_r rating_r_4 bestsellers_rating"><i></i><i></i><i></i><i></i><i></i></div>
                                ...
                                <div class="bestsellers_item">
                                    <div class="bestsellers_item_container d-flex flex-row align-items-center justify-content-start">
                                        <div class="bestsellers_image"><img src="https://cdn.tgdd.vn/Products/Images/42/222596/oppo-reno4-275620-035629-600x600.jpg" alt=""></div>
                                        <div class="bestsellers_content">
                ...
                <div class="col">
                    <div class="newsletter_container d-flex flex-lg-row flex-column align-items-lg-center align-items-center justify-content-lg-start justify-content-center">
                        <div class="newsletter_title_container">
                            ...
                            <div class="newsletter_text"><p> Khuyến mãi 10%</p></div>
                        </div>
                        <div class="newsletter_content clearfix">
                            <form action="#" class="newsletter_form">
                                <input type="email" class="newsletter_input" required="required" placeholder="Nhập email của bạn">
