              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Chào Mừng Bạn Đến Với IBUY!</h1>
                  </div>
                  <form class="user" action="{{URL::to('/admin-login')}}" method="post">{{csrf_field()}}
                    <?php
                  ...
                  <div class="text-center">
                    <a class="small" href="{{URL::to('/register_auth')}}">Tạo một tài khoản!</a>
                  </div>
                </div>
              </div>
            </div>
